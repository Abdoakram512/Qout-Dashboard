...
export const translations = {
  ar: {
    app_title: "مؤسسة الفجر الخيرية",
    admin_portal: "لوحة تحكم الإدارة العامة",
    login_title: "تسجيل دخول المشرف",
    login_subtitle: "لوحة التحكم المركزية لإدارة مؤسسة الفجر والمستفيدين ومنافذ الصرف",
    ...
    nav_merchants: "إدارة منافذ الصرف والميزانيات",
    nav_accounts: "إدارة الحسابات والتفعيل",
    nav_transactions: "سجل عمليات الصرف",
    nav_disbursements: "طلبات الصرف الإضافي",
    ...
    kpi_budget: "إجمالي الميزانيات المخصصة",
    kpi_remaining_budget: "السيولة المتبقية بعهد الصرافين",
    currency: "ج.م",
    baskets: "سلة",
    search_placeholder: "بحث بالاسم، رقم الكارت، الرقم القومي...",
    export_pdf: "تصدير PDF رسمي",
    ...
    // New Feature Keys
    filter_recipients_all: "📋 جميع الحالات",
    filter_recipients_received: "✅ مستلمون هذا الشهر",
    filter_recipients_not_received: "❌ لم يستلموا بعد",
    filter_recipients_last_month: "📅 مستلمون الشهر السابق",
    filter_recipients_dormant: "⚠️ متخلفون عن الاستلام",
    allocated_budget: "الميزانية المخصصة",
    remaining_budget: "الرصيد المتبقي",
    disbursed_amount: "المصروف الفعلي",
    send_payment_receipt: "إرسال وصل دفع",
    allocate_budget: "تخصيص رصيد",
    disbursement_requests: "طلبات الصرف الإضافي",
    monthly_audit: "التقرير المحاسبي الشهري",
  ...
  en: {
    ...
    nav_merchants: "Merchants & Budgets",
    nav_accounts: "Accounts & Approvals",
    nav_transactions: "Redemption Transactions",
    nav_disbursements: "Extra Disbursement Requests",
    ...
    kpi_budget: "Total Allocated Budgets",
    kpi_remaining_budget: "Remaining Merchant Liquidity",
    currency: "EGP",
    baskets: "baskets",
    ...
    // New Feature Keys
    filter_recipients_all: "📋 All Cases",
    filter_recipients_received: "✅ Received This Month",
    filter_recipients_not_received: "❌ Not Received Yet",
    filter_recipients_last_month: "📅 Received Last Month",
    filter_recipients_dormant: "⚠️ Dormant Cases",
    allocated_budget: "Allocated Budget",
    remaining_budget: "Remaining Balance",
    disbursed_amount: "Total Disbursed",
    send_payment_receipt: "Send Payment Receipt",
    allocate_budget: "Allocate Budget",
    disbursement_requests: "Disbursement Requests",
    monthly_audit: "Monthly Audit Report",
